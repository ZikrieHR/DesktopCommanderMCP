...
/**
 * Normalize line endings to match the target style - Single-pass performance optimization
 * Replaces any CRLF, LF, or CR directly with the target line ending in a single regex pass,
 * avoiding multiple string allocations and regex scans.
 */
